    ...
    <div class="container mx-auto mt-20 py-8 w-4/5 max-w-full">
        ...
        <div x-data="{
            ...
            <div class="flex overflow-hidden">
                ...
                <template x-for="(product, index) in [...products, ...products].slice(currentIndex, currentIndex + 4)"
                    :key="product.id">
                    <div class="w-1/4 px-4">
                                ...
                                <div
                                    ...
                                    <form :action="'{{ route('user.like') }}'" method="GET" class="inline">
                                        ...
                                        <button type="submit"
                                            ...
                                            :title="product.isFavorite ? 'Remove from Wishlist' : 'Add to Wishlist'">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            <div class="flex-1">
                                <a :href="'/products_clients/show/' + product.id"
