                                            ...
                                            <form action="{{ route('orders.update', $order->id) }}" method="POST">
                                                ...
                                                <select id="status" name="status"
                                                    ...
                                                    <option value="pending"
                                                        @if ($order->status == 'pending') selected @endif>@lang('messages.Pending')
                                                    </option>
                                                    <option value="accepted"
                                                        @if ($order->status == 'accepted') selected @endif>@lang('messages.Accepted')
                                                    </option>
                                                    <option value="in progress"
                                                        @if ($order->status == 'in progress') selected @endif>@lang('messages.In_Progress')
                                                    </option>
                                                    <option value="delivered"
                                                        @if ($order->status == 'delivered') selected @endif>@lang('messages.Delivered')
                                                    </option>
                                                    <option value="cancelled"
                                                        @if ($order->status == 'cancelled') selected @endif>@lang('messages.Cancelled')
                                                    </option>
                                                </select>
                                                <button type="submit"
