<div class="bg-primary text-white py-3 flex justify-center items-center cursor-pointer hover:bg-tertiary transition-colors duration-300 mt-40"
    onclick="window.scrollTo({top: 0, behavior: 'smooth'});">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="size-6 hover:scale-125 transition-transform duration-300">
        <path stroke-linecap="round" stroke-linejoin="round"
            d="m15 11.25-3-3m0 0-3 3m3-3v7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
</div>

<div class="bg-secondary text-gray-600 pt-6 "> <!-- Aumentar la separación del footer -->
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mt-8 px-20">
        <!-- About Us -->
        ...
        <!-- Customer Service -->
        <div class="text-center">
            <h4 class="font-bold mb-4 text-primary text-xl border-b-2 border-primary pb-2 uppercase">Customer Service
            </h4>
            <ul>
        ...
        <div class="col-span-2 flex flex-col items-center justify-center">
            ...
            <div class="flex justify-center space-x-8">
                <a href="https://www.youtube.com" target="_blank">
                    <svg fill="currentColor" width="40px" height="40px" viewBox="0 0 32 32"
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-10 h-10 text-primary hover:text-tertiary transition-colors duration-300">
                        <path
                ...
                <a href="https://www.twitter.com" target="_blank">
                    <svg fill="currentColor" width="40px" height="40px" viewBox="-4 0 32 32" version="1.1"
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-10 h-10 text-primary hover:text-tertiary transition-colors duration-300">
                        <title>twitter</title>
                        <path
                ...
                <a href="https://www.instagram.com" target="_blank">
                    <svg fill="currentColor" height="40px" width="40px" viewBox="0 0 48 48" version="1.1"
                        id="Shopicons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        class="w-8 h-10 text-primary hover:text-tertiary transition-colors duration-300">
                        <path
  ...
  s4.5-10,10-10s10,4.5,10,10S29.5,34,24,34z M35,15c-1.1,0-2-0.9-2-2c0-1.1,0.9-2,2-2s2,0.9,2,2C37,14.1,36.1,15,35,15z" />
    ...
    <div class="w-full bg-primary py-4 mt-8 mx-auto">
        <div class="container mx-auto text-center text-sm mt-0">
