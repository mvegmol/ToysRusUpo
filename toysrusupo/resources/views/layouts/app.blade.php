...
<body class="min-h-screen flex flex-col">
    ...
    <header class='border-b bg-white font-sans min-h-[60px] relative tracking-wide relative z-50'>
        <div class='flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4'>
            <a href="javascript:void(0)"><img src="{{ asset('images/icons/toysrusupo.png') }}" alt="logo"
                    class='w-36' />
            </a>
            ...
            @else
                ...
                <div class='flex items-center mr-10 ml-auto space-x-8'>
                    ...
                    <a href="{{ Auth::check() ? route('carts.show_products') : route('login') }}">
                        <span class="relative">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="#4A5568"
                                class="size-8 cursor-pointer hover:stroke-primary">
                                <path stroke-linecap="round" stroke-linejoin="round"
