                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('products.index') }}">Todos los
                                            productos</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="#!">Juguetes más vendidos</a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="#!">Juguetes más seguidos</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
