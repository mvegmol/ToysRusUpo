...
return [
    ...
    "toys_li"=>"Juguetes Mas Gustados",
    "cant"=>"Cantidad",
    "price"=>"Precio",
    "carrito_cliente"=>"Carrito Cliente",
    "resumen"=>"Resumen",
    "envio"=>"Envío",
    "cust"=>"Cliente",
    "pr_or"=>"Pedido Anterior",
    "dir"=>"Dirección de Envio",
    "ord"=>"Pedido",
    "cat"=>"Categoría",
    ...
    "Pending"=>"Pendiente",
    "Accepted"=>"Aceptado",
    "In_Progress"=>"En envío",
    "Delivered"=>"Enviado",
    "Cancelled"=>"Cancelado",
    "year"=>"este año",
    "six"=>"los últimos 6 meses",
    "tres"=>"los últimos 3 meses",
    "mont"=>"este mes",
    "week"=>"esta semana",
